...
export default function SideList() {
    ...
    () => [
      {
        ...
        icon: <GroupIcon />,
        link: 'tabla',
        component: <Tabladeaceptacion {...{ setSelectedLink, link: 'tabla' }} />,
      },
      {
        title: 'Pendientes',
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      <CssBaseline />
      <AppBar className='menu-dashboard' open={open}>
        <Toolbar>
          <IconButton
            color="inherit"
      ...
      <Drawer className='lista-dashboard' variant="permanent" open={open}>
        <DrawerHeader>
